...
set(RIGEL_SAVE_CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS})
set(RIGEL_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY ${CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
set(CMAKE_CXX_FLAGS ${RIGEL_SAVE_CMAKE_CXX_FLAGS})
set(CMAKE_RUNTIME_OUTPUT_DIRECTORY ${RIGEL_SAVE_CMAKE_RUNTIME_OUTPUT_DIRECTORY})
...
# targets.
add_subdirectory(${rigel_gtest_src_dir} ${rigel_gtest_build_dir} EXCLUDE_FROM_ALL)
