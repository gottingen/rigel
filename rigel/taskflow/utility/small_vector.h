...
*/
    ...
    void SmallVectorTemplateBase<T, isPodLike>::grow(size_t MinSize) {
        ...
        size_t NewCapacity = size_t(rigel::detail::NextCapacity(CurCapacity + 2));
...
*/
    ...
    public:
        ...
        */
        ...
        //explicit SmallVector(const rigel::iterator_range<RangeTy> &R)
        //    : SmallVectorImpl<T>(N) {
...
namespace std {
    ...
    template<typename T>
    inline void
    swap(rigel::SmallVectorImpl<T> &LHS, rigel::SmallVectorImpl<T> &RHS) {
        LHS.swap(RHS);
    }
    ...
    template<typename T, unsigned N>
    inline void
    swap(rigel::SmallVector<T, N> &LHS, rigel::SmallVector<T, N> &RHS) {
        LHS.swap(RHS);
    }
