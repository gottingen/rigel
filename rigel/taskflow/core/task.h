...
or std::function<int(rigel::Runtime&)>.
*/
template <typename C>
...
std::function<rigel::SmallVector<int>()> or
std::function<rigel::SmallVector<int>(rigel::Runtime&)>.
*/
template <typename C>
...
or std::function<void(rigel::Runtime&)>.
*/
template <typename C>
...
class Task {
  ...
  public:
    ...
    */
    ...
    rigel::Taskflow taskflow("attach data to a task");
    ...
    */
    ...
    rigel::TaskPriority::HIGH (numerically equivalent to 0),
    rigel::TaskPriority::NORMAL (numerically equivalent to 1), and
    rigel::TaskPriority::LOW (numerically equivalent to 2).
...
@brief hash specialization for std::hash<rigel::Task>
*/
template <>
struct hash<rigel::Task> {
  auto operator() (const rigel::Task& task) const noexcept {
...
@brief hash specialization for std::hash<rigel::TaskView>
*/
template <>
struct hash<rigel::TaskView> {
  auto operator() (const rigel::TaskView& task_view) const noexcept {
