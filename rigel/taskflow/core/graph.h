...
#include "rigel/taskflow/utility/os.h"
#include "rigel/taskflow/utility/math.h"
#include "rigel/taskflow/utility/small_vector.h"
#include "rigel/taskflow/utility/serializer.h"
#include "rigel/taskflow/core/error.h"
#include "rigel/taskflow/core/declarations.h"
#include "rigel/taskflow/core/semaphore.h"
#include "rigel/taskflow/core/environment.h"
#include "rigel/taskflow/core/topology.h"
#include "rigel/taskflow/core/tsq.h"
...
std::tie(A, B, C, D) = taskflow.emplace(
  [] () { return 0; },
  [&C] (rigel::Runtime& rt) {  // C must be captured by reference
    std::cout << "B\n";
    rt.schedule(C);
  },
  [] () { std::cout << "C\n"; },
...
*/
    ...
    public:
        ...
        */
        ...
        The difference to rigel::Executor::async is that the created asynchronous task
        ...
        */
        ...
        /**
        @brief similar to rigel::Runtime::async but assigns the task a name
        ...
        */
        ...
        This member function is more efficient than rigel::Runtime::async
        ...
        */
        ...
        /**
        @brief similar to rigel::Runtime::silent_async but assigns the task a name
        ...
        */
        ...
        /**
        @brief similar to rigel::Runtime::silent_async but the caller must be the worker of the runtime
        ...
        */
        ...
        taskflow.emplace([](rigel::Runtime& rt){
          rt.corun([](rigel::Subflow& sf){
            rigel::Task A = sf.emplace([](){});
            rigel::Task B = sf.emplace([](){});
          });
        });

        // co-run a taskflow and wait until all tasks complete
        rigel::Taskflow taskflow1, taskflow2;
        taskflow1.emplace([](){ std::cout << "running taskflow1\n"; });
        taskflow2.emplace([&](rigel::Runtime& rt){
        ...
        Although rigel::Runtime::corun blocks until the operation completes,
        ...
        */
        ...
        Immediately joins all asynchronous tasks (rigel::Runtime::async,
        rigel::Runtime::silent_async).
        Unlike rigel::Subflow::join, you can join multiples times from
        a rigel::Runtime object.
        ...
        @attention
        Only the worker of this rigel::Runtime can issue join.
        */
        inline void join();
