...
#include "rigel/taskflow/core/notifier.h"
...
from an observer derived from rigel::ObserverInterface.
*/
class WorkerView {
...
The rigel::WorkerInterface class lets users interact with the executor
...
@note
Methods defined in rigel::WorkerInterface are not thread-safe and may be
...
/**
@brief helper function to create an instance derived from rigel::WorkerInterface

@tparam T type derived from rigel::WorkerInterface
