...
#include "rigel/taskflow/core/executor.h"
...
// Function: silent_dependent_async
    ...
    >
    rigel::AsyncTask Executor::silent_dependent_async(F &&func, Tasks &&... tasks) {
...
// Function: silent_dependent_async
    template<typename F, typename... Tasks,
            std::enable_if_t<all_same_v<AsyncTask, std::decay_t<Tasks>...>, void> *
    >
    rigel::AsyncTask Executor::silent_dependent_async(
...
// Function: silent_dependent_async
    ...
    >
    rigel::AsyncTask Executor::silent_dependent_async(F &&func, I first, I last) {
...
// Procedure: _process_async_dependent
    inline void Executor::_process_async_dependent(
            Node *node, rigel::AsyncTask &task, size_t &num_dependents
    ) {
