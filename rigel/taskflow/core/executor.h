...
#include "rigel/taskflow/core/observer.h"
#include "rigel/taskflow/core/taskflow.h"
#include "rigel/taskflow/core/async_task.h"
...
namespace rigel {
    ...
    rigel::Task A = taskflow.emplace([] () { std::cout << "This is TaskA\n"; });
    rigel::Task B = taskflow.emplace([] () { std::cout << "This is TaskB\n"; });
    rigel::Task C = taskflow.emplace([] () { std::cout << "This is TaskC\n"; });

    // Build precedence between tasks
    A.precede(B, C);

    rigel::Future<void> fu = executor.run(taskflow);
    ...
    */
    ...
    public:
        ...
        via deriving an instance from rigel::WorkerInterface.
        */
        explicit Executor(
        ...
        */
        ...
        @param taskflow a rigel::Taskflow object

        @return a rigel::Future that holds the result of the execution

        This member function executes the given taskflow once and returns a rigel::Future
        object that eventually holds the result of the execution.

        @code{.cpp}
        rigel::Future<void> future = executor.run(taskflow);
        // do something else
        future.wait();
        @endcode
        ...
        */
        rigel::Future<void> run(Taskflow &taskflow);

        /**
        @brief runs a moved taskflow once

        @param taskflow a moved rigel::Taskflow object

        @return a rigel::Future that holds the result of the execution

        This member function executes a moved taskflow once and returns a rigel::Future
        object that eventually holds the result of the execution.
        The executor will take care of the lifetime of the moved taskflow.

        @code{.cpp}
        rigel::Future<void> future = executor.run(std::move(taskflow));
        // do something else
        future.wait();
        @endcode
        ...
        */
        ...
        This member function returns a rigel::Future object that
        eventually holds the result of the execution.

        @code{.cpp}
        rigel::Future<void> future = executor.run(taskflow, [](){ std::cout << "done"; });
        // do something else
        future.wait();
        @endcode
        ...
        */
        template<typename C>
        rigel::Future<void> run(Taskflow &taskflow, C &&callable);
        ...
        @code{.cpp}
        rigel::Future<void> future = executor.run(
        ...
        */
        ...
        This member function executes the given taskflow @c N times and returns a rigel::Future
        object that eventually holds the result of the execution.

        @code{.cpp}
        rigel::Future<void> future = executor.run_n(taskflow, 2);  // run taskflow 2 times
        // do something else
        future.wait();
        @endcode
        ...
        */
        rigel::Future<void> run_n(Taskflow &taskflow, size_t N);
        ...
        This member function executes a moved taskflow @c N times and returns a rigel::Future
        object that eventually holds the result of the execution.
        The executor will take care of the lifetime of the moved taskflow.

        @code{.cpp}
        rigel::Future<void> future = executor.run_n(
        ...
        */
        ...
        @param taskflow a rigel::Taskflow
        @param N number of runs
        @param callable a callable object to be invoked after this run
        ...
        */
        template<typename C>
        rigel::Future<void> run_n(Taskflow &taskflow, size_t N, C &&callable);

        /**
        @brief runs a moved taskflow for @c N times and then invokes a callback

        @param taskflow a moved rigel::Taskflow
        @param N number of runs
        @param callable a callable object to be invoked after this run
        ...
        */
        ...
        @code{.cpp}
        rigel::Future<void> future = executor.run_until(
        ...
        */
        template<typename P>
        rigel::Future<void> run_until(Taskflow &taskflow, P &&pred);
        ...
        */
        ...
        rigel::Future<void> run_until(Taskflow &taskflow, P &&pred, C &&callable);
        ...
        */
        ...
        @tparam T target type which has `rigel::Graph& T::graph()` defined
        @param target the target task graph object

        The method runs a target graph which has `rigel::Graph& T::graph()` defined
        and waits until the execution completes.
        Unlike the typical flow of calling `rigel::Executor::run` series
        ...
        @code{.cpp}
        rigel::Executor executor(2);
        rigel::Taskflow taskflow;
        std::array<rigel::Taskflow, 1000> others;
        ...
        @attention
        You must call rigel::Executor::corun from a worker of the calling executor
        or an exception will be thrown.
        */
        template<typename T>
        void corun(T &target);
        ...
        @attention
        You must call rigel::Executor::corun_until from a worker of the calling executor
        or an exception will be thrown.
        */
        template<typename P>
        ...
        */
        ...
        @code{.cpp}
        rigel::Executor executor(4);   // 4 workers in the executor
        ...
        */
        ...
        @tparam Observer observer type derived from rigel::ObserverInterface
        ...
        rigel::ObserverInterface::on_entry and rigel::ObserverInterface::on_exit
        ...
        */
        ...
        /**
        @brief similar to rigel::Executor::async but does not return a future object

        @tparam F callable type

        @param func callable object

        This member function is more efficient than rigel::Executor::async
        ...
        */
        ...
        @tparam F callable type
        @tparam Tasks task types convertible to rigel::AsyncTask

        @param func callable object
        @param tasks asynchronous tasks on which this execution depends

        @return a rigel::AsyncTask handle

        This member function is more efficient than rigel::Executor::dependent_async
        and is encouraged to use when you do not want a @std_future to
        acquire the result or synchronize the execution.
        ...
        @code{.cpp}
        rigel::AsyncTask A = executor.silent_dependent_async([](){ printf("A\n"); });
        rigel::AsyncTask B = executor.silent_dependent_async([](){ printf("B\n"); });
        ...
        */
        ...
        >
        rigel::AsyncTask silent_dependent_async(F &&func, Tasks &&... tasks);
        ...
        @code{.cpp}
        rigel::AsyncTask A = executor.silent_dependent_async("A", [](){ printf("A\n"); });
        rigel::AsyncTask B = executor.silent_dependent_async("B", [](){ printf("B\n"); });
        ...
        */
        template<typename F, typename... Tasks,
                std::enable_if_t<all_same_v<AsyncTask, std::decay_t<Tasks>...>, void> * = nullptr
        >
        rigel::AsyncTask silent_dependent_async(const std::string &name, F &&func, Tasks &&... tasks);
        ...
        @code{.cpp}
        std::array<rigel::AsyncTask, 2> array {
        ...
        */
        ...
        >
        rigel::AsyncTask silent_dependent_async(F &&func, I first, I last);
        ...
        */
        template<typename F, typename I,
                std::enable_if_t<!std::is_same_v<std::decay_t<I>, AsyncTask>, void> * = nullptr
        >
        rigel::AsyncTask silent_dependent_async(const std::string &name, F &&func, I first, I last);
        ...
        @return a pair of a rigel::AsyncTask handle and
                          a @std_future that holds the result of the execution

        The example below creates three asynchronous tasks, @c A, @c B, and @c C,
        in which task @c C runs after task @c A and task @c B.
        Task @c C returns a pair of its rigel::AsyncTask handle and a std::future<int>
        ...
        You can mixed the use of rigel::AsyncTask handles
    ...
    private:
        ...
        void _process_async_dependent(Node *, rigel::AsyncTask &, size_t &);
...
// Function: run
    inline rigel::Future<void> Executor::run(Taskflow &f) {
        return run_n(f, 1, []() {});
    }
...
// Function: run
    template<typename C>
    rigel::Future<void> Executor::run(Taskflow &f, C &&c) {
...
// Function: run_n
    inline rigel::Future<void> Executor::run_n(Taskflow &f, size_t repeat) {
...
// Function: run_n
    template<typename C>
    rigel::Future<void> Executor::run_n(Taskflow &f, size_t repeat, C &&c) {
        return run_until(
...
// Function: run_until
    template<typename P>
    rigel::Future<void> Executor::run_until(Taskflow &f, P &&pred) {
...
// Function: run_until
    template<typename P, typename C>
    rigel::Future<void> Executor::run_until(Taskflow &f, P &&p, C &&c) {
        ...
        if (empty || p()) {
            ...
            return rigel::Future<void>(promise.get_future(), std::monostate{});
        }
        ...
        rigel::Future<void> future(t->_promise.get_future(), t);
...
// Function: run_until
    template<typename P, typename C>
    rigel::Future<void> Executor::run_until(Taskflow &&f, P &&pred, C &&c) {
...
// Procedure: corun
    ...
    void Runtime::corun(T &&target) {
        ...
        if constexpr (is_dynamic_task_v<T>) {
            ...
            // a composable graph object with `rigel::Graph& T::graph()` defined
        else {
