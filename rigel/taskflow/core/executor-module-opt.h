...
*/
    ...
    public:
        ...
        */
        ...
        @return a rigel::Future that will holds the result of the execution

        The method creates an asynchronous task to launch the given
        function on the given arguments.
        Unlike std::async, the return here is a @em rigel::Future that holds
        ...
        @code{.cpp}
        rigel::Future<std::optional<int>> future = executor.async([](){
        ...
        */
        ...
        Unlike std::async, the return here is a rigel::Future that holds
        an optional object to the result.
        If the asynchronous task is cancelled before it runs, the return is
        a @c std::nullopt, or the value returned by the callable.

        @code{.cpp}
        rigel::Future<std::optional<int>> future = executor.named_async("name", [](){
        ...
        */
        ...
        /**
        @brief similar to rigel::Executor::named_async but does not return a future object

        This member function is more efficient than rigel::Executor::named_async
        and is encouraged to use when there is no data returned.
