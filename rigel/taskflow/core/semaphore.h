...
A rigel::Semaphore object starts with an initial count.
...
rigel::Semaphore semaphore(1); // create a semaphore with initial count 1
...
*/
    ...
    public:
        ...
        @code{.cpp}
        rigel::Semaphore semaphore(4);  // concurrency constraint of 4 workers
        @endcode
        */
