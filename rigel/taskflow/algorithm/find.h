...
#include "rigel/taskflow/algorithm/launch.h"
...
// Function: find_if
template <typename B, typename E, typename T, typename UOP, typename P>
Task rigel::FlowBuilder::find_if(B first, E last, T& result, UOP predicate, P&& part) {
...
template <typename B, typename E, typename T, typename UOP, typename P>
Task rigel::FlowBuilder::find_if_not(B first, E last, T& result, UOP predicate, P&& part) {
