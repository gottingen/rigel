...
namespace rigel {
    ...
    to schedule parallel iterations (e.g., rigel::Taskflow::for_each).

    An partitioner defines the scheduling method for running parallel algorithms,
    such rigel::Taskflow::for_each, rigel::Taskflow::reduce, and so on.
    By default, we provide the following partitioners:

    + rigel::GuidedPartitioner to enable guided scheduling algorithm of adaptive chunk size
    + rigel::DynamicPartitioner to enable dynamic scheduling algorithm of equal chunk size
    + rigel::StaticPartitioner to enable static scheduling algorithm of static chunk size
    + rigel::RandomPartitioner to enable random scheduling algorithm of random chunk size
    ...
    iteration, rigel::StaticPartitioner can deliver the best performance.
    On the other hand, if the work unit per iteration is irregular and unbalanced,
    rigel::GuidedPartitioner or rigel::DynamicPartitioner can outperform rigel::StaticPartitioner.
    In most situations, rigel::GuidedPartitioner can deliver decent performance and
...
Similar to rigel::DynamicPartitioner,
...
/**
@brief default partitioner set to rigel::GuidedPartitioner
...
A partitioner is a derived type from rigel::PartitionerBase.
*/
    template<typename C>
