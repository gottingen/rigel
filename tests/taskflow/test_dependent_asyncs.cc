...
void silent_dependent_async_linear_chain(unsigned W) {
  ...
  int N = 100000;
  std::vector<rigel::CachelineAligned<int>> results(N);
  std::vector<rigel::AsyncTask> tasks;
...
void simple_graph_2(unsigned W) {
  ...
  size_t count = 10;
  std::vector<rigel::CachelineAligned<int>> results(count);
  std::vector<rigel::AsyncTask> tasks1;
  std::vector<rigel::AsyncTask> tasks2;
  std::vector<rigel::AsyncTask> tasks3;
  std::vector<rigel::AsyncTask> tasks4;
...
auto make_complex_graph(rigel::Executor& executor, int r) {
  
  int count = 10202;
  std::vector<rigel::CachelineAligned<int>> results(count);
  std::vector<rigel::AsyncTask> tasks_level_1;
  std::vector<rigel::AsyncTask> tasks_level_2;
  std::vector<rigel::AsyncTask> tasks_level_3;
...
void binary_tree(unsigned W) {
  ...
  std::vector<rigel::AsyncTask> tasks_p, tasks_c;
  std::array<rigel::AsyncTask, 1> dep;
  size_t task_id = 1;
...
void complete_linear_chain(unsigned W) {
  ...
  rigel::Executor executor0(W);
  rigel::Executor executor1(W);

  int N = 1000;
  std::vector<rigel::CachelineAligned<int>> results(2*N);
  std::vector<rigel::AsyncTask> tasks;
...
void parallel_graph_construction(unsigned W) {
  ...
  int L = 500;
  int id = 0;
  std::vector<rigel::Task> tasks((1+L)*L/2);
  std::vector<int> data((1+L)*L/2, -1);
  
  std::vector<rigel::AsyncTask> async_tasks((1+L)*L/2);
